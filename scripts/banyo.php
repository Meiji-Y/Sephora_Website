				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="page-title">
							<b><h1, style= "color: #000000 ; font-size:75px">Vücut ve Banyo</h1></b> <br>
							<h4, style= "color: #000000 ; font-size:20px">Hayatın yoğun akışına vücut ve banyo ürünleri ile kısa bir mola verebilirsiniz. Vücut kremleri, duş jelleri, sabunlar, deodorantlar, vücut yağları ve aklınıza gelebilecek pek çok vücut ve banyo ürününü Sephora sizin için bir araya getiriyor.</h4>
				...
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
						...
						<div class="category-area-start">
							<div class="caregory">
								<h3 class="bedroom-side-title">VÜCUT VE BANYO KATEGORİLERİ</h3>
								<ul>
									<li> <div class="checkbox">
										<label>
											<input type="checkbox"> Nemlendirici Krem <span>(4)</span>
										</label>
									</div>
								    </li>
								    	<li> <div class="checkbox">
								    		<label>
								    			<input type="checkbox"> Scrub & Peeling <span>(1)</span>
								    		</label>
								    	</div>
								        </li>
								        	<li> <div class="checkbox">
								        		<label>
								        			<input type="checkbox"> El Bakımı <span>(0)</span>
								        		</label>
								        	</div>
								            </li>
											...
											<li> <div class="checkbox">
								        		<label>
								        			<input type="checkbox"> Besleyici Yağ <span>(0)</span>
								        		</label>
								        	</div>
								            </li>
											...
											<li> <div class="checkbox">
								        		<label>
								        			<input type="checkbox"> Banyo & Duş <span>(0)</span>
								        		</label>
								        	</div>
								            </li>
						...
						<div class="category-area-start">
							<div class="caregory manufacturer mt-40">
								<h3 class="bedroom-side-title"> ÖNE ÇIKAN VÜCUT VE BANYO MARKALARI </h3>
								<ul>
									<li> <div class="checkbox">
										<label>
								    	...
								    	<li> <div class="checkbox">
								    		<label>
								    			<input type="checkbox"> MERCI HANDY <span>(14)</span>
								    		</label>
								    	</div>
								        </li>
								        	<li> <div class="checkbox">
								        		<label>
								        			<input type="checkbox"> CLARINS <span>(14)</span>
								        		</label>
								        	</div>
								            </li>
								            	<li> <div class="checkbox">
								            		<label>
								            			<input type="checkbox"> BAIJA <span>(14)</span>
								            		</label>
								            	</div>
								                </li>
								...
								<div class="tab-pane active" id="viewed">
                                    ...
                                    <div id="display-image">
                                        ...
                                        <?php
                                            ...
                                            $query = " select * from products where category='banyo'";
