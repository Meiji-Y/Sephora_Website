...
<!-- Header finishes -->
		...
		<div class="page-title-wrapper" style="border:rgb(0, 0, 0); border-width:15px; border-style:solid; background: url(img/categories/banyo_category_bg.jpeg) no-repeat scroll center center / cover;">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="page-title">
							<b><h1, style= "color: #000000 ; font-size:75px">Saç</h1></b> <br>
							<h4, style= "color: #000000 ; font-size:20px">Tüm saç tiplerine ve ihtiyaçlarına uygun şampuanlar, kremler, maskeler, serumlar, modaya uygun aksesuarlar ve kaliteli bakım ürünleri ile saçlarınıza hak ettiği değeri verebilirsiniz. İster kıvırcık, ister ince telli, ister normal veya çabuk yağlanan saçlara sahip olun, Sephora’da ihtiyacınız olan tüm saç bakım ürünlerini bulabilirsiniz.</h4>
				...
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
						...
						<div class="category-area-start">
							<div class="caregory">
								<h3 class="bedroom-side-title">SAÇ KATEGORİLERİ</h3>
								<ul>
						...
						<div class="category-area-start">
							<div class="caregory manufacturer mt-40">
								<h3 class="bedroom-side-title"> ÖNE ÇIKAN SAÇ MARKALARI </h3>
								<ul>
									<li> <div class="checkbox">
										<label>
								...
								<div class="tab-pane active" id="viewed">
                                    ...
                                    <div id="display-image">
                                        ...
                                        <?php
                                            ...
                                            $query = " select * from products where category='sac'";
