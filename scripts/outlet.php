...
<!-- Header finishes -->
		...
		<div class="page-title-wrapper" style="border:rgb(0, 0, 0); border-width:15px; border-style:solid; background-color:#00008B;">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:#00008B">
						<div class="page-title">
							<b><h1, style= " font-size:75px; background-color:#00008B color: #000000;">Outlet</h1></b>
				...
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
						...
						<div class="category-area-start">
							<div class="caregory">
								<h3 class="bedroom-side-title">OUTLET KATEGORİLERİ</h3>
								<ul>
									<li> <div class="checkbox">
										<label>
											<input type="checkbox"> Saç Maskesi <span>(4)</span>
										</label>
									</div>
								    </li>
								    	<li> <div class="checkbox">
								    		<label>
								    			<input type="checkbox"> Şampuan <span>(1)</span>
								    		</label>
								    	</div>
								        </li>
								        	<li> <div class="checkbox">
								        		<label>
								        			<input type="checkbox"> Saç Kremi <span>(0)</span>
								        		</label>
								        	</div>
								            </li>
											...
											<li> <div class="checkbox">
								        		<label>
								        			<input type="checkbox"> Durulanmayan Saç Bakım <span>(0)</span>
								        		</label>
								        	</div>
								            </li>
											...
											<li> <div class="checkbox">
								        		<label>
								        			<input type="checkbox"> Serum <span>(0)</span>
								        		</label>
								        	</div>
								            </li>
											<li> <div class="checkbox">
										<label>
											<input type="checkbox"> Kadın Parfüm <span>(4)</span>
										</label>
									</div>
								    </li>
								    	<li> <div class="checkbox">
								    		<label>
								    			<input type="checkbox"> Erkek Parfüm <span>(1)</span>
								    		</label>
								    	</div>
								        </li>
								        	<li> <div class="checkbox">
								        		<label>
								        			<input type="checkbox"> Parfüm Setleri <span>(0)</span>
								        		</label>
								        	</div>
								            </li>
											<li> <div class="checkbox">
										<label>
											<input type="checkbox"> Göz <span>(1)</span>
										</label>
									</div>
								    </li>
								    	<li> <div class="checkbox">
								    		<label>
								    			<input type="checkbox"> Yüz <span>(1)</span>
								    		</label>
								    	</div>
								        </li>
								        	<li> <div class="checkbox">
								        		<label>
								        			<input type="checkbox"> Dudak <span>(2)</span>
								        		</label>
								        	</div>
								            </li>
											...
											<li> <div class="checkbox">
								        		<label>
								        			<input type="checkbox"> Kaş <span>(0)</span>
								        		</label>
								        	</div>
								            </li>
											...
											<li> <div class="checkbox">
								        		<label>
								        			<input type="checkbox"> Paletler <span>(1)</span>
								        		</label>
								        	</div>
								            </li>
											...
											<li> <div class="checkbox">
								        		<label>
								        			<input type="checkbox"> Setler <span>(0)</span>
								        		</label>
								        	</div>
								            </li>
						...
						<div class="category-area-start">
							<div class="caregory manufacturer mt-40">
								<h3 class="bedroom-side-title"> ÖNE ÇIKAN OUTLET MARKALARI </h3>
								<ul>
									<li> <div class="checkbox">
										<label>
											<input type="checkbox"> SEPHORA COLLECTION <span>(14)</span>
										</label>
									</div>
								    </li>
								    	<li> <div class="checkbox">
								    		<label>
								    			<input type="checkbox"> OLAPLEX <span>(14)</span>
								    		</label>
								    	</div>
								        </li>
								        	<li> <div class="checkbox">
								        		<label>
								        			<input type="checkbox"> BRIOGEO <span>(14)</span>
								        		</label>
								        	</div>
								            </li>
								            	<li> <div class="checkbox">
								            		<label>
								            			<input type="checkbox"> TANGLE TEEZER <span>(14)</span>
								            		</label>
								            	</div>
								                </li>
												<li> <div class="checkbox">
										<label>
											<input type="checkbox"> YVES SAINT LAURENT <span>(14)</span>
										</label>
									</div>
								    </li>
								    	<li> <div class="checkbox">
								    		<label>
								    			<input type="checkbox"> ARMANI <span>(14)</span>
								    		</label>
								    	</div>
								        </li>
								        	<li> <div class="checkbox">
								        		<label>
								        			<input type="checkbox"> LANCOME <span>(14)</span>
								        		</label>
								        	</div>
								            </li>
								            	<li> <div class="checkbox">
								            		<label>
								            			<input type="checkbox"> NARCISO <span>(14)</span>
								            		</label>
								            	</div>
								                </li>
                                        ...
                                        <?php
                                            ...
                                            while ($data = mysqli_fetch_assoc($result)) {
                                                ...
                                                ?>
													...
													<a target= "_blank" href="product-detailss.php?urun=<?php echo $data['id']; ?>"  >
                                                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                <div class="single-new-product mt-40 category-new-product">
                                                                    <div class="product-img">
                                                                    <a target= "_blank" href="product-detailss.php?urun=<?php echo $data['id']; ?>"  >
                                                                       
                                                                            <img src="./products/<?php echo $data['filename']; ?> "class="first_img" alt="">
                                                                        </a>
                                                                        <div class="new-product-action">
                                                                            <!-- <a href="#"><span class="lnr lnr-sync"></span></a> -->
                                                                            <a target= "_blank" href="cart.php?urun=<?php echo $data['id']; ?>"><span class="lnr lnr-cart cart_pad"></span>Sepete Ekle</a>
                                                                        </div>
                                                                    </div>
                                                                    <div class="product-content text-center">
                                                                        <a target= "_blank" href="product-detailss.php?urun=<?php echo $data['id']; ?>"  ><h3><?php echo $data['name']; ?></h3></a>
                                                                        <div class="price">
                                                                            <h4><?php echo $data['price']; ?> TL</h4> 
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
