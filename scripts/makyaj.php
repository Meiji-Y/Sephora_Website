...
<!-- Header finishes -->
		...
		<div class="page-title-wrapper"  style= "  border:black; border-width:15px; border-style:solid; background: url(img/categories/makyaj_category_bg.jpeg) no-repeat scroll center center / cover;">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="page-title">
							<b><h1, style= "color: #000000 ; font-size:75px">Makyaj</h1></b> <br>
							<h4, style= "color: #000000 ; font-size:20px"> Doğru ve kaliteli makyaj malzemeleriyle yapılmış bir makyaj ile istediğiniz görünümü elde edebilirsiniz. Makyaj malzemeleri, ojeler, makyaj aksesuarları ve daha birçok ürüne Sephora kalitesi ile sahip olabilirsiniz.</h4>
				...
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
						...
						<div class="category-area-start">
							<div class="caregory">
								<h3 class="bedroom-side-title">MAKYAJ KATEGORİLERİ</h3>
								<ul>
						...
						<div class="category-area-start">
							<div class="caregory manufacturer mt-40">
								<h3 class="bedroom-side-title"> ÖNE ÇIKAN MAKYAJ MARKALARI </h3>
								<ul>
									<li> <div class="checkbox">
										<label>
											<input type="checkbox"> TOO FACED <span>(14)</span>
										</label>
									</div>
								    </li>
								    	<li> <div class="checkbox">
								        	...
								        	<li> <div class="checkbox">
								        		<label>
								        			<input type="checkbox"> BENEFIT COSMETICS <span>(14)</span>
								        		</label>
								        	</div>
								            </li>
								            	<li> <div class="checkbox">
								            		<label>
								            			<input type="checkbox"> FENTY <span>(14)</span>
								            		</label>
								            	</div>
								                </li>
								...
								<div class="tab-pane active" id="viewed">
                                    ...
                                    <div id="display-image">
                                        ...
                                        <?php
                                            ...
                                            $query = " select * from products where category='makyaj'";
