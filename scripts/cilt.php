...
<!-- Header finishes -->
		...
		<div class="page-title-wrapper" style="border:rgb(0, 0, 0); border-width:15px; border-style:solid; background: url(img/categories/cilt_category_bg.jpeg) no-repeat scroll center center / cover;">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="page-title">
							<b><h1, style= "color: #000000 ; font-size:75px">Cilt Bakımı</h1></b> <br>
							<h4, style= "color: #000000 ; font-size:20px">Işıl ışıl ve pürüzsüz görünen bir cilde sahip olmanın yolu, düzenli yüz bakımı ve doğru bakım ürünlerini kullanmaktan geçer. Sephora tüm cilt tiplerine ve ihtiyaçlarına uygun yüz bakım ürünleri arasından dilediğiniz seçerek cildinizi şımartabilirsiniz.</h4>
				...
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
						...
						<div class="category-area-start">
							<div class="caregory">
								<h3 class="bedroom-side-title">CİLT BAKIMI KATEGORİLERİ</h3>
								<ul>
									<li> <div class="checkbox">
										<label>
											<input type="checkbox"> Serum <span>(4)</span>
										</label>
									</div>
								    </li>
								    	<li> <div class="checkbox">
								    		<label>
								    			<input type="checkbox"> Gündüz Kremi <span>(1)</span>
								    		</label>
								    	</div>
								        </li>
								        	<li> <div class="checkbox">
								        		<label>
								        			<input type="checkbox"> Gece Kremi <span>(0)</span>
								        		</label>
								        	</div>
								            </li>
											...
											<li> <div class="checkbox">
								        		<label>
								        			<input type="checkbox"> Maskeler <span>(0)</span>
								        		</label>
								        	</div>
								            </li>
											...
											<li> <div class="checkbox">
								        		<label>
								        			<input type="checkbox"> Göz Çevresi <span>(0)</span>
								        		</label>
								        	</div>
								            </li>
											...
											<li> <div class="checkbox">
								        		<label>
								        			<input type="checkbox"> Tonik <span>(0)</span>
								        		</label>
								        	</div>
								            </li>
						...
						<div class="category-area-start">
							<div class="caregory manufacturer mt-40">
								<h3 class="bedroom-side-title"> ÖNE ÇIKAN CİLT BAKIM MARKALARI </h3>
								<ul>
									<li> <div class="checkbox">
										<label>
											<input type="checkbox"> DRUNK ELEPHANT <span>(14)</span>
										</label>
									</div>
								    </li>
								    	<li> <div class="checkbox">
								    		<label>
								    			<input type="checkbox"> LANEIGE <span>(14)</span>
								    		</label>
								    	</div>
								        </li>
								        	<li> <div class="checkbox">
								            	...
								            	<li> <div class="checkbox">
								            		<label>
								            			<input type="checkbox"> CLINIQUE <span>(14)</span>
								            		</label>
								            	</div>
								                </li>
								...
								<div class="tab-pane active" id="viewed">
                                    ...
                                    <div id="display-image">
                                        ...
                                        <?php
                                            ...
                                            $query = " select * from products where category='cilt'";
